	...
	<div class="container">
		<div class="content">
			...
			if(mysqli_num_rows($sql) == 0){
				header("Location: ./views/index-table-order-pent-shipp.php");
			}else{
			...
			if(isset($_GET['pesan']) == 'sukses'){
				...
				$apellido_cliente = "Mogollon";				
				$direccionab = "La pastora, de carmen a santa elena";			
				...
				curl_setopt($ch, CURLOPT_POSTFIELDS, "{
				  \"orderNumber\": \"TEST-ORDER-API-DOCS-2-prueba3-0 test\",
				  \"orderKey\": \"0f6bec18-3e89-4881-83aa-f392d84f4c74-2019-24\",
				  \"orderDate\": \"07/29/2015\",
				  \"paymentDate\": \"06/29/2015\",
			...
			<form class="form-horizontal" action="" method="post">
				...
				<?php if($row['note_shipp']==""){
					echo '<div class="form-group">
					<label class="col-sm-3 control-label">Comentario del ERR</label>
					<div class="col-sm-4">
						<textarea name="noteShipp" maxlength="64000" style="height: 100px;" class="form-control" placeholder="Comentario del ERR"></textarea>
						</div>
					</div>';
				}else{
					echo '<div class="form-group">
					<label class="col-sm-3 control-label">Comentario del ERR</label>
					<div class="col-sm-4">
						<textarea name="noteShippcoment" maxlength="64000" style="height: 100px;" class="form-control" readonly="readonly">'.$row['note_shipp'].'</textarea>
						</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="submit" name="shipping" class="btn btn-sm btn-success" value="Enviar">
